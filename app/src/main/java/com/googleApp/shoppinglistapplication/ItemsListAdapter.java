    ...
    public void onBindViewHolder(@NonNull ItemsListAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickListener.itemClick(itemsList.get(holder.getAdapterPosition()));
            }
        });
        ...
        holder.editCategory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                clickListener.editItem(itemsList.get(holder.getAdapterPosition()));
            }
        });
        ...
        holder.removeCategory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                clickListener.removeItem(itemsList.get(holder.getAdapterPosition()));
            }
        });
        if(this.itemsList.get(holder.getAdapterPosition()).completed){
